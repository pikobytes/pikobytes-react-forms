...
export default function TextField(props) {
    ...
    return (_jsx(React.Fragment, { children: _jsx(MUITextField, { disabled: disabled, error: isErroneous, helperText: isErroneous ? error.message : description, inputRef: function (e) {
            ...
            }, rows: rows, name: fieldId, placeholder: placeholder === undefined ? label : placeholder, fullWidth: true, size: size, InputLabelProps: { required: required !== false, shrink: true }, type: getHTMLType(fieldType), variant: variant, sx: function (theme) { return ({
