...
export function DateTimePicker(_a) {
    ...
    return (_jsx(MUIDateTimePicker, __assign({ ampm: false, clearable: true, disabled: disabled, disableFuture: disableFuture, renderInput: function (props) { return (_jsx(TextField, __assign({}, props, { InputLabelProps: { required: showRequiredLabel, shrink: true }, fullWidth: true, helperText: isErroneous ? error.message : description, placeholder: placeholder, size: size, variant: variant }))); }, inputFormat: "yyyy/MM/dd, HH:mm", mask: "____/__/__, __:__", InputProps: {
