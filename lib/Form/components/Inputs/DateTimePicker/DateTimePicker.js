...
export function DateTimePicker(_a) {
    var fieldId = _a.fieldId, _b = _a.uiSettings, description = _b.description, label = _b.label, placeholder = _b.placeholder, size = _b.size, variant = _b.variant, validation = _a.validation;
    ...
    return (_jsx(MUIDateTimePicker, __assign({ clearable: true, renderInput: function (props) { return _jsx(TextField, __assign({}, props, { fullWidth: true, helperText: error !== undefined ? error.message : description, placeholder: placeholder, size: size, variant: variant }), void 0); }, ampm: false, disableFuture: true, inputFormat: "yyyy/MM/dd, HH:mm", mask: "____/__/__, __:__", InputProps: {
