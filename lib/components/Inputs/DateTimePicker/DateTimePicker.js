...
export function DateTimePicker(_a) {
    ...
    return (_jsx(MUIDateTimePicker, __assign({ clearable: true, disabled: disabled, renderInput: function (props) { return (_jsx(TextField, __assign({}, props, { InputLabelProps: { required: showRequiredLabel, shrink: true }, fullWidth: true, helperText: isErroneous ? error.message : description, placeholder: placeholder, size: size, variant: variant }), void 0)); }, ampm: false, disableFuture: true, inputFormat: "yyyy/MM/dd, HH:mm", mask: "____/__/__, __:__", InputProps: {
