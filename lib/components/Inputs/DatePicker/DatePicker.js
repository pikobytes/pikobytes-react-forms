...
export function DatePicker(_a) {
    ...
    return (_jsx(MUIDatePicker, __assign({ clearable: true, disabled: disabled, disableFuture: disableFuture, renderInput: function (props) { return (_jsx(TextField, __assign({}, props, { error: isErroneous, InputLabelProps: { required: showRequiredLabel, shrink: true }, fullWidth: true, helperText: isErroneous ? error.message : description, placeholder: placeholder, size: size, variant: variant }))); }, inputFormat: "yyyy/MM/dd", mask: "____/__/__", InputProps: {
