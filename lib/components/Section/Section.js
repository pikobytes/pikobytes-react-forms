...
export var Section = function (_a) {
    ...
    return (_jsxs(Grid, __assign({ container: true, direction: "row", alignItems: "center", spacing: 2, sx: { paddingBottom: 4 } }, { children: [title !== undefined && (_jsx(Grid, __assign({ item: true, xs: 12 }, { children: _jsx(Typography, __assign({ color: "primary", variant: "h3", sx: function (theme) { return ({
                        ...
                        mt: 3,
                        mb: 1,
                    }); } }, { children: title })) }))), fields.map(function (field) {
                var _a;
                var fieldConfig;
                try {
                ...
                return (effect === E_CONDITION_EFFECTS.DISPLAY && isMet) ||
                    effect !== E_CONDITION_EFFECTS.DISPLAY ? (_jsx(Grid, __assign({ item: true, xs: (_a = fieldUiSettings.columns) !== null && _a !== void 0 ? _a : 12 }, { children: _jsx(FieldComponent, { customProperties: customProperties, fieldId: field, fieldType: fieldType, loading: loading, uiSettings: uiSettingsWithConditionsApplied, validation: validationRules }) }), field)) : (_jsx(_Fragment, {}));
            })] })));
};
