...
export var TagManagement = function (props) {
    ...
    return (_jsxs(Grid, __assign({ container: true, spacing: 2 }, { children: [_jsx(Grid, __assign({ item: true, xs: 12 }, { children: _jsxs(Grid, __assign({ alignItems: "center", container: true, spacing: 1 }, { children: [_jsx(Grid, __assign({ item: true, xs: true }, { children: component === 'input' || isAutosuggestWithoutOptions ? (_jsx(InputComponent, {})) : (_jsx(Autocomplete, { clearOnBlur: true, renderInput: InputComponent, onChange: handleAutocompleteSelect, options: options !== undefined ? options : [] })) })), component === 'input' && (_jsx(Grid, __assign({ item: true, xs: "auto" }, { children: _jsx(Tooltip, __assign({ title: addButtonTooltip }, { children: _jsx(IconButton, __assign({ className: "button", onClick: onClickAdd }, { children: _jsx(AddIcon, {}) })) })) })))] })) })), _jsx(Grid, __assign({ item: true, xs: 12 }, { children: _jsx(Grid, __assign({ container: true, spacing: 1 }, { children: tags.map(function (tag) {
