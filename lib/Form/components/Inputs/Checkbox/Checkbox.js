...
export default function Checkbox(props) {
    var _a;
    var fieldId = props.fieldId, _b = props.uiSettings, label = _b.label, size = _b.size, validation = props.validation;
    ...
    return (_jsxs(FormControl, __assign({ error: isErroneous, fullWidth: true, required: required !== false, size: size }, { children: [_jsx(FormGroup, { children: _jsx(FormControlLabel, { control: _jsx(MUICheckBox, __assign({}, field, { checked: (_a = field.value) !== null && _a !== void 0 ? _a : false, onChange: function (e) {
