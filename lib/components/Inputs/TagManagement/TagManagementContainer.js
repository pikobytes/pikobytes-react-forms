...
export function TagManagementContainer(props) {
    ...
    return (_jsx(TagManagement, __assign({ onTagCreate: onTagCreate, onTagRemove: onTagRemove, onTagRemoveReversed: onTagRemoveAbort, tags: tags, tagsToDelete: tagsToDelete }, props)));
}
