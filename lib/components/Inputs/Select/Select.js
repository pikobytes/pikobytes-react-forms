...
export default function Select(_a) {
    ...
    return (_jsxs(FormControl, __assign({ disabled: disabled, error: isErroneous, fullWidth: true, size: size, variant: variant }, { children: [_jsx(InputLabel, __assign({ htmlFor: label, required: showRequiredLabel, shrink: true }, { children: label }), void 0), _jsxs(MUISelect, __assign({ onBlur: onBlur, onChange: handleChange, inputRef: ref, label: label, native: true, value: value === '' ? EMPTY_VALUE : value, sx: function (theme) { return ({
